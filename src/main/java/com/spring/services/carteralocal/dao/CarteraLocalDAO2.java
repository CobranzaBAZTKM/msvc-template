        ...
        try{
            ...
            for(int i=0;i<cuenta.size();i++){
                if(!validarCU.equals(cuenta.get(i).getCLIENTE_UNICO())) {
                    ...
                    LOGGER.log(Level.INFO, () -> "Valor duplicado insertarCarteraDescarte CU: "+CUdpli);
                }
            ...
            respuesta.setMessage("ISSUE insertarCarteraDescarte: "+e);
            LOGGER.log(Level.INFO, () -> "ISSUE insertarCarteraDescarte: "+e);
        }
        return respuesta;
    }
